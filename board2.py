...
class Board:
    ...
    def evaluate_2(self, computer_color: str):
        """
        Alternative evaluation function, evaluating edges as 4 and corners as 6
        :param computer_color: The color of the computer
        :return:
        """
        board_value: int = 0
        ...
        for row in range(0, ROWS):
            for column in range(0, COLUMNS):
                ...
                if (row == 0 and 1 < column < 6) or (row == 7 and 1 < column < 6) or (row == 0 and 1 < column < 6) \
